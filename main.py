...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='./datasets/data/VOCdevkit/VOC2007',
...
def main():
    ...
    elif  opts.dataset == 'custom' and not opts.crop_val:
        opts.val_batch_size = 1   
    ...
    def save_ckpt(path):
        ...
        torch.save({
            "cur_itrs": cur_itrs,
            "model_state": model.module.state_dict(), #model.state_dict(),
